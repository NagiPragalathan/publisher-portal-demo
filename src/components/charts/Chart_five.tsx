...
const Chart_five = () => {
  return (
    ...
    <div className="relative mt-4 h-[200px] w-full flex justify-center">
        <Image
          src="/image/progress_dotted_five.png"
          alt="Progress Path"
          fill
          className="object-contain !h-[93vh] mt-[-24vh]"
        />
    </div>  
    ...
    <div className="relative w-full max-w-[280px] flex flex-col items-center">
      {/* Student Image */}
        <Image
          ...
          width={120}
          height={120}
          className={`object-contain h-[23vh] w-[32vh] mt-[-17vh] ml-[13vh] ${styles.studentImage}`}
        />

      {/* Button */}
      <Link href="/multiselect">
